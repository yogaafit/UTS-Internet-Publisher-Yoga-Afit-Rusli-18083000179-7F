        ...
        <div class="card">
            ...
            <form method="post" action="ganti_password.php">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="pass_lama">
                </div>
                <div class="form-group">
                    <label>Masukkan password baru anda!....</label>
                    <input type="email" class="form-control" name="pass_baru">
                </div>
                <div class="form-group">
                    <label>Konfirmasi sekali lagi password baru anda!...</label>
                    <input type="email" class="form-control" name="konfirmasi_pass">
                </div>
